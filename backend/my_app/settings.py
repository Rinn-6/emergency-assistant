...
if not TWILIO_PHONE_NUMBER_TO:
    raise ValueError("TWILIO_PHONE_NUMBER_TO is missing!")

# Quick-start development settings - unsuitable for production
# See https://docs.djangoproject.com/en/5.1/howto/deployment/checklist/

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = 'django-insecure-g0vdvd(m$m_o$&^u$-z(&0hvrb9gvtcuzx$#&k#$=e@)uq9@h9'
...
ASGI_APPLICATION = "emergency_backend.asgi.application"
